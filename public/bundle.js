...
var Duration = function (_React$Component) {
	...
	_createClass(Duration, [{
		...
		key: 'tick',
		value: function tick() {
			var updatedTime = Math.round((Date.now() - this.state.start) / 1000);
			this.setState({
...
var ObjectiveTimer = function (_React$Component2) {
	_inherits(ObjectiveTimer, _React$Component2);

	function ObjectiveTimer(props) {
		_classCallCheck(this, ObjectiveTimer);

		var _this3 = _possibleConstructorReturn(this, (ObjectiveTimer.__proto__ || Object.getPrototypeOf(ObjectiveTimer)).call(this, props));

		_this3.state = {
			ObjectiveText: ''
		};
		_this3.handleNewActionKeyDown = _this3.handleNewActionKeyDown.bind(_this3);
		return _this3;
	}

	_createClass(ObjectiveTimer, [{
...
_reactDom2.default.render(_react2.default.createElement(ObjectiveTimer, null), document.getElementById('root'));
