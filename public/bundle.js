...
function TaskList(props) {
	var taskListItems = props.tasks.map(function (task) {
		return _react2.default.createElement(TaskListItem, {
			key: task.id,
...
var TaskPlanApp = function (_React$Component) {
	_inherits(TaskPlanApp, _React$Component);

	function TaskPlanApp(props) {
		_classCallCheck(this, TaskPlanApp);

		var _this = _possibleConstructorReturn(this, (TaskPlanApp.__proto__ || Object.getPrototypeOf(TaskPlanApp)).call(this, props));

		_this.state = {
			items: []
		};
		_this.handleNewActionKeyDown = _this.handleNewActionKeyDown.bind(_this);
		return _this;
	}

	_createClass(TaskPlanApp, [{
		key: 'handleNewActionKeyDown',
		value: function handleNewActionKeyDown(event) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(TaskList, { tasks: this.state.items })
			);
		}
	}]);
...
_reactDom2.default.render(_react2.default.createElement(TaskPlanApp, null), document.getElementById('root'));
